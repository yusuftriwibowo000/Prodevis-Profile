		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-12 col-md-6 mt-5">
					<div class="blog-post">
						<h2 class="blog-post__title">Change Password</h2>
						<?= $this->session->flashdata('message'); ?>
						<form method="POST" action="<?= base_url('Auth_password');?>">
							<div class="row my-3">
							<div class="col-md-8 offset-md-2 mb-4">
								<h5 class="text-center">
									<label for="password_lama" class="mb-0">Previous password :</label>
								</h5>
								<input class="form-control simpli-border shadow" placeholder="Enter Previous password" name="password_lama"
								id="password_lama" type="password">
								<?= form_error('password_lama', '<small class = "text-danger pl-3">', '</small>'); ?>
							</div>
							<div class="col-md-8 offset-md-2 mb-4">
								<h5 class="text-center">
									<label for="password_baru1" class="mb-0">New password :</label>
								</h5>
								<input class="form-control simpli-border shadow" placeholder="Enter New password" name="password_baru1"
								id="password_baru1" type="password">
								<?= form_error('password_baru1', '<small class = "text-danger pl-3">', '</small>'); ?>
							</div>
							<div class="col-md-8 offset-md-2 mb-4">
								<h5 class="text-center">
									<label for="password_baru2" class="mb-0">Confirm Password :</label>
								</h5>
								<input class="form-control simpli-border shadow" placeholder="Confirm Password" name="password_baru2"
							...
							<div class="col-md-12 text-center">
								<button type="submit" class="primary-btn my-3">
									Update Now <span class="lnr lnr-arrow-right align-middle"></span>
								</button>
							</div>
						</div>
						</form>
