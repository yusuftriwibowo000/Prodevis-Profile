...
<div class="main">
    <div class="jumbotron gradient text-white rounded-0 text-center slope">
        <div class="container pb-1 pt-1">
            <h1>Create your <span>Giveaway</span> now.</h1>
            <p class="lead mt-3">Choose the Contest you want to run.</p>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-sm-8 col-md-7">
                <div class="row">
                    ...
                    <div class="col-12 col-md-12 sweepstake">
                        <a href="apps/youtube-giveaway.html">
                            <div class="card">
                                <div class="card-body">
                    ...
                    <!-- <div class="col-12 col-md-12 sweepstake">
                        <a href="apps/twitter-giveaway.html">
                            <div class="card">
                                <div class="card-body">
