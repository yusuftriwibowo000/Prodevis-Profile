...
<div class="form-group">
<label>Subject</label>
<select onchange="onChange(event)" name="subject" required="" class="form-control form-control-lg form-control-inverse">
...
<div class="form-group">
<label>Message</label>
<textarea name="message" required class="form-control form-control-lg form-control-inverse" id="" cols="30" rows="6"></textarea>
</div>
