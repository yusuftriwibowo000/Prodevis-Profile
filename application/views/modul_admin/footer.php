  ...
  <script src="<?= base_url('assets_admin/js/custom/sweetalert/sweetalert2.all.min.js') ?>"></script>
  <script src="<?= base_url('assets_admin/js/custom/lightbox2-11/js/lightbox.min.js') ?>"></script>
