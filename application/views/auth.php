			...
			<div class="modal-body">
				<div class="modal-container">
					...
					<form method="post" action="<?= base_url(); ?>">
						...
						<div class="row my-3">
							<div class="col-md-12 my-2">
								...
								<input required type="text" type="email" class="form-control simpli-border shadow-sm"
									id="emailForLogin" name="email" value="<?= set_value('email'); ?>">
					...
					<a href="#" data-toggle="modal" data-target="#registerModal"
						class="primary-btn border-0 d-block m-1 p-2">Register<span class="lnr lnr-chevron-right"></span>
					</a>
