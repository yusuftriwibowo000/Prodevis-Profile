...
<div class="main">
    <div class="jumbotron gradient rounded-0 text-white text-center slope">
        ...
        <p class="lead mt-3">Pick a winner from a list of participants</p>
            <div class="row justify-content-center">
                <div class="col-12 col-md-8 col-lg-5	 mt-5">
                <form onsubmit="return submitSorteadosForm();" id="createForm" action="<?= base_url("Apps"); ?>" method="POST">
                    <textarea style=" border:0; box-shadow: 0px 0px 13px 2px rgba(0, 0, 0, 0.1);" placeholder="Enter names here. Each name must be on a new line"
                    name="participants" id="sorteadosTextarea" cols="30" rows="9" class="form-control p-4"></textarea>
                    <div class="text-center mt-4">
                    <button id="sorteadosSubmit" disabled="true" class="btn btn-outline-light">Start</button>
                    </div>
                    <input type="hidden" name="type" value="random-name">
                </form>
...
<script type='text/javascript' src="<?= base_url(); ?>vendors/platform-api.sharethis.com/js/sharethis.js#property=5ea4443da10c1200152b4814&product=sticky-share-buttons&cms=sop" async='async'></script>
    <div class="container">
    <div class="row justify-content-center">
    <div class="col-12 col-md-10 col-lg-8 mt-5">
    <div class="blog-post">
    <h2 class="blog-post__title">What is online Random Name Picker free tool?</h2>
    <p><strong>Random Name Picker</strong> is a free online tool where you can quickly pick a winner from a list of names, participants, things, cities, and whatever you want.</p>
    <p>By entering the list of names in the text field and clicking the start button, we will randomly selecting one or more name(s) from all names as a winners. With our <strong>Pick a Winner App</strong> you can filter out duplicate entries and pick multiple winners.</p>
    <p>You can use our <strong>Random Name Selector</strong> for contests, giveaways, raffles, drawings, promotions and competitions! It's totally free.</p>
    <p>In the end, we will generate a public link with a <strong>unique certificate</strong> with its results. You can share this certificate so everyone can verify the authenticity of your contest. Certificates are totally free.</p>
    <h2 class="blog-post__tiatle mt-6">How does <strong>Random Name Picker</strong> work?</h2>
    <p class="mb-4">Pick a <strong>random winner</strong> from a list of names or participants with our <strong>random name selector</strong>. It's simple and free, just follow this steps:</p>
    <ul class="steps">
    <li>Enter your list of names/participants/things in the textarea, each on a new line or separated by comma</li>
    <li>You can also copy the list from Excel, or comments on the web, and paste here in the textarea</li>
    <li>Start the app via the "Start" button!</li>
    <li>Setup the options. Enter the amount of winners</li>
    <li>Optional, you can check "Remove Duplicates". This option will give the same chances to everyone</li>
    <li>Click on "Start" button again, and share your results!</li>
    </ul>
    </div> </div>
    </div>
    </div>
    ...
    <p>You must enter at least 2 participants.</p>
    <p>Each name must be a NEW LINE.</p>
    </div>
...
<script>mixpanel.track("AS_ViewRandomNamesLanding");</script>
<script>
    var isios = function () {
