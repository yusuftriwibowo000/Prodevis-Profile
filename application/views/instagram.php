...
<div class="main">
<div class="jumbotron gradient rounded-0 text-white text-center mb-0">
<div class="container pb-1 pt-1">
<h1 class="display-5">Free Instagram Comment Picker</h1>
<p class="lead mt-3">Pick a random comment winner from your Instagram photos and videos, for free.</p>
...
<i class="icon-double-check mr-2"></i>This is a MultiPost Giveaway. <a target="_blank" href="../blog/instagram-multi-accounts-giveaways.html">Learn more.</a>
</div>
