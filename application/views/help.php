...
<div class="card-body">
Yes, we do not have Subcription Plans yet.You need to pay to unock specific post, and then you can run unlimited times the same giveways. </div>
</div>
</div>
<div class="card faq">
...
<div class="card-body">
Yes. You can add filters to make sure the participants accomplish few conditions. Until today, we have 3 filters: REMOVE DUPLICATES, FILTER BY @MENTION and FILTER BY #HASHTAGS. To read more about filters, please visit this post: <div class="text-center pt-5">
<a href="blog/filters-instagram-comments-giveaway.html" class="btn btn-primary">Filtering giveways comments</a>
</div>
</div>
</div>
</div>
...
<div class="card-body">
Yes, please send us the IG Post and your business details and we will send to you the invoice. </div>
</div>
</div>
</div>
...
<style>
.card-header { background-color: #fff; display: flex; align-items: center;}
.card-header .fas { color: #aaa; margin-right: 10px; }
.faq-title {
	font-size: 16px;
	font-weight: 400;
	width: 100%;
...
.card-header:hover { background-color: #ddd; cursor: pointer; }
.card-header:not(.collapsed) { color: blue; background-color: #fff; }
.card-header:not(.collapsed) .faq-title { color: blue; }
